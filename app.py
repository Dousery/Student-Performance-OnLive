...
model_path = os.path.join(working_dir, "student_performance_model.sav")

try:
    performance_model = pickle.load(open(model_path, 'rb'))
except FileNotFoundError:
    st.error("Model file not found. Please ensure 'student_performance_model.sav' is in the same directory as this script.")
    st.stop()
